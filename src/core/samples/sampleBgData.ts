 ...
 *
 * Public API for sample BG data. Provides pre-designed BG graphics that
 * pair with sample programs. Each BG is a 28x21 grid of cells with
 * character codes and color patterns.
 */

import { BG_GRID } from '@/features/bg-editor/constants'
import type { BgGridData } from '@/features/bg-editor/types'

import { MANUAL_SAMPLE_BG_GRIDS } from './sampleBgManualGrids'
import { createEmptyGrid, setCell } from './sampleBgVisualGrid'

// ============================================================================
// IDE Demo Grid Creators
// ============================================================================
