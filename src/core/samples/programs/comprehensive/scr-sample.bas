...
150 MOVE 1:PLAY "O1C1C1C1"
160 S0=STICK(0)
170 S=S0:GOSUB 280:GOSUB 290
180 IF D=0 THEN 250
190 DEF MOVE(0)=SPRITE(4,D,1,3,0,0)
200 POSITION 0,PX,PY
210 MOVE 0:PLAY "O3B1D1"
220 XX=(PX+7)/8-2:YY=(PY+7)/8-3
230 IF SCR$(XX,YY)=CHR$(199) THEN LOCATE XX,YY:PRINT " ":CN=CN+1:LOCATE 10,23:PRINT "SCORE:";CN:PLAY "O4C1A1G1"
...
350 RETURN
360 PLAY "O4G1C1G1":FOR Q=0 TO 3:CGSET 0,0:CGSET 1,1:CGSET 0,0:NEXT
370 PLAY "O1C1G1A1C1D1":CLS:SPRITE OFF
