...
export const lesson9Sprites: Lesson = {
  ...
  content: [
    ...
    'You specify the sprite number, its size,',
    'pattern, display mode, and color:',
    '```basic',
    'DEF SPRITE n,(x,y,p,m,c)=CHR$(code)',
    '```',

    '- `n` — Sprite number (0 to 7)',
    '- `x` — Width in pixels (8 or 16)',
    '- `y` — Height in pixels (8 or 16)',
    '- `p` — Pattern number (which graphic to use)',
    '- `m` — Display mode (0 = normal, 1 = flip horizontal)',
    ...
    '```basic',
    '10 SPRITE ON',
    '20 DEF SPRITE 0,(16,16,0,0,1)=CHR$(225)',
    '30 SPRITE 0,100,100',
    '40 LOCATE 0,22',
    '```',
    ...
    '10 SPRITE ON',
    '20 DEF SPRITE 0,(16,16,0,0,1)=CHR$(225)',
    '30 DEF SPRITE 1,(16,16,0,0,2)=CHR$(226)',
    '40 DEF SPRITE 2,(16,16,0,0,3)=CHR$(227)',
    '50 SPRITE 0,50,100',
    '60 SPRITE 1,100,100',
    '70 SPRITE 2,150,100',
    '80 LOCATE 0,22',
    ...
    'Use the `(x,y)` part of `DEF SPRITE` to set',
    'the size:',
    '- `(8,8,...)` — Small sprite (8x8 pixels)',
    '- `(16,16,...)` — Large sprite (16x16 pixels)',
    ...
    '```basic',
    '10 SPRITE ON',
    '20 DEF SPRITE 0,(16,16,0,0,0)=CHR$(225)',
    '30 DEF SPRITE 1,(16,16,0,0,1)=CHR$(226)',
    '40 FOR I=0 TO 10',
