...
export const lesson13SpriteColors: Lesson = {
  ...
  content: [
    ...
    '10 SPRITE ON',
    '20 PALETS 0, 6, 5, 4, 3',
    '30 DEF SPRITE 0,(16,16,0,0,0)=CHR$(225)',
    '40 DEF SPRITE 1,(16,16,0,0,1)=CHR$(225)',
    '50 DEF SPRITE 2,(16,16,0,0,2)=CHR$(225)',
    '60 DEF SPRITE 3,(16,16,0,0,3)=CHR$(225)',
    '70 SPRITE 0,20,80',
    '80 SPRITE 1,70,80',
    '90 SPRITE 2,120,80',
    '100 SPRITE 3,170,80',
    ...
    '30 PALETB 0, 1, 2, 8, 9',
    '40 CGSET 0, 0',
    '50 DEF SPRITE 0,(16,16,0,0,1)=CHR$(225)',
    '60 FOR I=0 TO 150',
    '70 PRINT CHR$(225);',
    '80 NEXT',
    '90 VIEW',
    ...
    '30 PALETB 0, 1, 2, 8, 9',
    '40 CGSET 0, 0',
    '50 DEF SPRITE 0,(16,16,0,0,0)=CHR$(225)',
    '60 DEF SPRITE 1,(16,16,0,0,1)=CHR$(226)',
    '70 DEF SPRITE 2,(16,16,0,0,2)=CHR$(227)',
    '80 DEF SPRITE 3,(16,16,0,0,3)=CHR$(228)',
    '90 SPRITE 0,30,60',
    '100 SPRITE 1,90,60',
    '110 SPRITE 2,150,60',
    '120 SPRITE 3,210,60',
